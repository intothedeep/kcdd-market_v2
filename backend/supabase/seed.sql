...
INSERT INTO user_profiles (id, user_type, is_vetted, email, name, org_tier, verification_status) VALUES
  ('00000000-0000-0000-0002-000000000001', 'cbo',   true,  'amara@connectingroots.org',   'Amara Johnson', 'small_org',  'verified'),
  ('00000000-0000-0000-0002-000000000002', 'cbo',   true,  'lin@kctechbridge.org',        'Lin Chen',      'large_org',  'verified'),
  ('00000000-0000-0000-0002-000000000003', 'cbo',   true,  'devon@digitalfutureskc.org',  'Devon Park',    'small_org',  'verified'),
  ('00000000-0000-0000-0003-000000000001', 'donor', false, 'donor1@example.com',          'Marcus Tanner', 'individual', 'unverified'),
  ('00000000-0000-0000-0003-000000000002', 'donor', false, 'donor2@example.com',          'Priya Sharma',  'individual', 'verified'),
  ('00000000-0000-0000-0003-000000000003', 'donor', false, 'donor3@example.com',          'James Wallace', 'individual', 'unverified')
...
INSERT INTO user_profiles (id, user_type, is_vetted, email, name, org_tier, verification_status) VALUES
  ('00000000-0000-0000-0002-000000000004', 'cbo', true, 'maya@northlandcode.org',         'Maya Okafor',  'large_org', 'verified'),
  ('00000000-0000-0000-0002-000000000005', 'cbo', true, 'samuel@heartlanddevicebank.org', 'Samuel Reyes', 'small_org', 'unverified')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO user_profiles (id, user_type, is_vetted, email, name, org_tier, verification_status) VALUES
  ('00000000-0000-0000-0002-000000000006', 'cbo', true, 'tariq@kcconnecthub.org', 'Tariq Hassan', 'large_org', 'verified')
ON CONFLICT (id) DO NOTHING;
