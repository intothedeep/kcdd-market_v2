    ...
    <div className="container py-8 md:py-12 lg:py-24">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="prose dark:prose-invert max-w-none space-y-6">
          ...
          <p>
            As an organization dedicated to bridging the digital divide, we believe that
            technology should be accessible to everyone. We strive to ensure our website is
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>
              <strong>Form Labels:</strong> All form inputs have associated labels for clarity
          ...
          <p>
            The accessibility of this website relies on the following technologies to work with
            your browser and any assistive technologies or plugins installed on your computer:
          </p>
          <ul className="list-disc list-inside space-y-2">
            <li>HTML</li>
            <li>CSS</li>
          ...
          <p>
            While we strive to ensure accessibility, some content may not be fully accessible.
            We are actively working to identify and resolve any accessibility barriers. Known
            issues include:
          </p>
          <ul className="list-disc list-inside space-y-2">
            <li>
          ...
          <p>
            We welcome your feedback on the accessibility of KC Digital Drive. Please let us
          ...
          <p>
            For questions about our accessibility efforts, please contact:
          </p>
          <p>
            KC Digital Drive<br />
            Email: accessibility@kcdigitaldrive.org<br />
            Kansas City, MO
          </p>
        </div>
      </div>
