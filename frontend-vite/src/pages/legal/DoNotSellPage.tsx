    ...
    <div className="container py-8 md:py-12 lg:py-24">
      <div className="mx-auto max-w-3xl space-y-8">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Your California Privacy Rights</p>
        </div>

        <div className="prose dark:prose-invert max-w-none space-y-6">
          <p>
            KC Digital Drive respects your privacy and is committed to complying with the California
          ...
          <p>
            ...
            sold personal information and has no plans to do so in the future. We believe your data
            belongs to you, and we only use it to provide and improve our services.
          </p>
          ...
          <p>
            ...
            personal information. Since we do not sell personal information, there is no need to
            submit an opt-out request. However, we want to be transparent about our practices and
          ...
          <ul className="list-inside list-disc space-y-2">
            <li>
              <strong>Know:</strong> Request information about the categories and specific pieces of
          ...
          <p>
            We work with trusted third-party service providers (such as payment processors and email
            services) who may process your data on our behalf. These providers are contractually
            obligated to protect your information and only use it for the specific purposes we
            direct.
          </p>
          ...
          <p>
            We will respond to verifiable consumer requests within 45 days. If we need more time, we
            will notify you of the reason and extension period.
          </p>

          <h2 className="text-2xl font-bold">Verification</h2>
          <p>
            To protect your privacy, we may need to verify your identity before processing your
            request. We will ask you to provide information that matches the information we have on
            file.
          </p>
          ...
          <p>
            ...
            verification that you have authorized the agent to act on your behalf.
          </p>

          <h2 className="text-2xl font-bold">Contact Us</h2>
          <p>If you have questions about this notice or your privacy rights, please contact us:</p>
          <p>
            KC Digital Drive
            <br />
